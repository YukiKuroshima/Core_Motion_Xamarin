...
static UILabel * native_to_managed_trampoline_5 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoObject *retval = NULL;
	guint32 exception_gchandle = 0;
	UILabel * res = {0};
...
static void native_to_managed_trampoline_6 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UILabel * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_8 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_10 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UILongPressGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_11 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIPanGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_12 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIRotationGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_13 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UITapGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_14 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIPinchGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_15 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UISwipeGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_16 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIScreenEdgePanGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "CoreMotion.AppDelegate, CoreMotion", "FinishedLaunching");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, "CoreMotion.AppDelegate, CoreMotion", ".ctor", &call_super);
		if (call_super && rv) {
...
@interface CoreMotionViewController : UIViewController {
	...
	@property (nonatomic, assign) UILabel * lblX;
	@property (nonatomic, assign) UILabel * lblY;
	@property (nonatomic, assign) UILabel * lblZ;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UILabel *) lblX;
	-(void) setLblX:(UILabel *)p0;
	-(UILabel *) lblY;
	-(void) setLblY:(UILabel *)p0;
	-(UILabel *) lblZ;
	-(void) setLblZ:(UILabel *)p0;
...
@implementation CoreMotionViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "get_lblX");
	}

	-(void) setLblX:(UILabel *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "CoreMotion.CoreMotionViewController, CoreMotion", "set_lblX");
	}

	-(UILabel *) lblY
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "get_lblY");
	}

	-(void) setLblY:(UILabel *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "CoreMotion.CoreMotionViewController, CoreMotion", "set_lblY");
	}

	-(UILabel *) lblZ
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "get_lblZ");
	}

	-(void) setLblZ:(UILabel *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "CoreMotion.CoreMotionViewController, CoreMotion", "set_lblZ");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "ViewDidLoad");
	}

	-(void) viewDidUnload
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", "ViewDidUnload");
	}

	-(BOOL) shouldAutorotateToInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, "UIKit.UIInterfaceOrientation, Xamarin.iOS", "CoreMotion.CoreMotionViewController, CoreMotion", "ShouldAutorotateToInterfaceOrientation");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, "CoreMotion.CoreMotionViewController, CoreMotion", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation __UIGestureRecognizerParametrizedToken { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "UIKit.UIGestureRecognizer, Xamarin.iOS", "UIKit.UIGestureRecognizer+ParametrizedDispatch, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UILongPressGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, "UIKit.UILongPressGestureRecognizer, Xamarin.iOS", "UIKit.UILongPressGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UIPanGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, "UIKit.UIPanGestureRecognizer, Xamarin.iOS", "UIKit.UIPanGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UIRotationGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_12 (self, _cmd, &managed_method, p0, "UIKit.UIRotationGestureRecognizer, Xamarin.iOS", "UIKit.UIRotationGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UITapGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_13 (self, _cmd, &managed_method, p0, "UIKit.UITapGestureRecognizer, Xamarin.iOS", "UIKit.UITapGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UIPinchGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, "UIKit.UIPinchGestureRecognizer, Xamarin.iOS", "UIKit.UIPinchGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UISwipeGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_15 (self, _cmd, &managed_method, p0, "UIKit.UISwipeGestureRecognizer, Xamarin.iOS", "UIKit.UISwipeGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
...
@implementation __UIScreenEdgePanGestureRecognizer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_16 (self, _cmd, &managed_method, p0, "UIKit.UIScreenEdgePanGestureRecognizer, Xamarin.iOS", "UIKit.UIScreenEdgePanGestureRecognizer+Callback, Xamarin.iOS", "Activated");
	}
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"CMAttitude", "CoreMotion.CMAttitude, Xamarin.iOS", NULL },
		...
		{"AppDelegate", "CoreMotion.AppDelegate, CoreMotion", NULL },
		{"CoreMotionViewController", "CoreMotion.CoreMotionViewController, CoreMotion", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [21].handle = objc_getClass ("CMAttitude");
	__xamarin_class_map [22].handle = objc_getClass ("CMLogItem");
	__xamarin_class_map [23].handle = objc_getClass ("CMDeviceMotion");
	__xamarin_class_map [24].handle = objc_getClass ("CMMotionManager");
	...
	__xamarin_class_map [48].handle = [CoreMotionViewController class];
